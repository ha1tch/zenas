; Z80 Assembler Macro System Test Examples - CORRECTED VERSION
; This file demonstrates both Traditional and C-style macro syntax with proper separation
...
; =============================================================================
; C-STYLE MACROS - CORRECTED VERSION
; =============================================================================
...
;   ADD A, B        ; Execute macro body (from asm{} block)
...
; 4. Processes asm{} blocks correctly in C-style macros
; 5. Provides clear error messages for macro-related issues
